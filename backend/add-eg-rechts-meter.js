...
// First, add the EG Rechts meter
const meterData = {
  facility_id: 1, // Main Building
  serial_number: '1EMH0010473016',
  type: 'electric',
  location: 'EG Rechts',
...
// Meter readings data for EG Rechts [1EMH0010473016]
const readings = [
  // January 2025
...
function addMeterAndReadings() {
  ...
  db.run(insertMeterQuery, [
    ...
    console.log(`✓ Added EG Rechts meter with ID: ${meterId}`);
