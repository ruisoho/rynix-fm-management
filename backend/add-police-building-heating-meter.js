...
console.log('Adding Police Building heating meter...');
...
db.run(`INSERT INTO electric_meters (facility_id, serial_number, type, location, installation_date, status) 
    ...
    function(err) {
        ...
        console.log(`Police Building heating meter added with ID: ${meterId}`);
        ...
        const readings = [
            ...
            { date: '2025-05-13', value: 5523.95 }, // Note: Potential data entry error - large jump
                ...
                db.run(`INSERT INTO meter_readings (meter_id, date, value) VALUES (?, ?, ?)`,
                    ...
                    function(err) {
                        ...
                        if (index === totalReadings - 1) {
                            console.log(`Successfully added ${addedCount} readings for Police Building heating meter`);
                            console.log('Note: Some readings were null and were skipped');
                            console.log('Warning: Reading on 2025-05-13 shows unusual jump to 5523.95 MWh - please verify');
                            db.close();
                        }
                    }
                );
